...
private:
	...
	Effect& operator = (const Effect& rhs) {};	//original version:	Effect& operator = (const Effect& rhs) 
												//https://stackoverflow.com/questions/19170564/overloading-operator-for-structs-within-classes
protected:
	ID3DX11Effect* mFX;
};
#pragma endregion
...
public:
	...
	//effect.cpp at least have 1 Technique, each Tech has at least 1 pass.
